var MarkerClusterer = function () {
    ...
    Q = e((function (t) {
      ...
      (t.exports = function (t, e, o, s) {
        var a = !!s && !!s.unsafe,
          u = !!s && !!s.enumerable,
          l = !!s && !!s.noTargetGet;
        "function" == typeof o && ("string" != typeof e || y(o, "name") || w(o, "name", e), r(o).source = i.join("string" == typeof e ? e : "")), t !== n ? (a ? !l && t[e] && (u = !0) : delete t[e], u ? t[e] = o : w(t, e, o)) : u ? t[e] = o : O(e, o)
  ...
  me || Q(Object.prototype, "toString", Me, {
    unsafe: !0
  });
  var be = function () {
      var t = E(this),
  ...
  Ot({
    ...
    reduce: function (t) {
      return Be(this, t, arguments.length, arguments.length > 1 ? arguments[1] : void 0)
    }
  });
  ...
  var $e, Fe, Ue = {
    ...
    We = Ge,
    Xe = ($e = /a/, Fe = /b*/g, Ge.call($e, "a"), Ge.call(Fe, "a"), 0 !== $e.lastIndex || 0 !== Fe.lastIndex),
    Ke = Ue.UNSUPPORTED_Y || Ue.BROKEN_CARET,
    qe = void 0 !== /()??/.exec("")[1];
  (Xe || qe || Ke) && (We = function (t) {
    var e, r, n, i, o = this,
      s = Ke && o.sticky,
      a = be.call(o),
      u = o.source,
      l = 0,
      c = t;
    return s && (-1 === (a = a.replace("y", "")).indexOf("g") && (a += "g"), c = String(t).slice(o.lastIndex), o.lastIndex > 0 && (!o.multiline || o.multiline && "\n" !== t[o.lastIndex - 1]) && (u = "(?: " + u + ")", c = " " + c, l++), r = new RegExp("^(?:" + u + ")", a)), qe && (r = new RegExp("^" + u + "$(?!\\s)", a)), Xe && (e = o.lastIndex), n = Ge.call(s ? r : o, c), s ? n ? (n.input = n.input.slice(l), n[0] = n[0].slice(l), n.index = o.lastIndex, o.lastIndex += n[0].length) : o.lastIndex = 0 : Xe && n && (o.lastIndex = o.global ? n.index + n[0].length : e), qe && n && n.length > 1 && Ve.call(n[0], r, (function () {
    ...
    ir = function (t, e, r, n) {
      var o = Kt(t),
        ...
        a = s && !i((function () {
          var e = !1,
            r = /a/;
          return "split" === t && ((r = {}).constructor = {}, r.constructor[Je] = function () {
            return r
          }, r.flags = "", r[o] = /./ [o]), r.exec = function () {
            return e = !0, null
          }, r[o](""), !e
        }));
      if (!s || !a || "replace" === t && (!Qe || !tr || rr) || "split" === t && !nr) {
        var u = /./ [o],
          l = r(o, "" [t], (function (t, e, r, n, i) {
            return e.exec === Ye ? s && !i ? {
              done: !0,
              value: u.call(e, r, n)
            } : {
              done: !0,
  ...
  ir("replace", 2, (function (t, e, r, n) {
    ...
    return [function (r, n) {
      ...
      for (var _, v = "", m = 0, y = 0; y < g.length; y++) {
        d = g[y];
        for (var x = String(d[0]), S = lr(cr(ot(d.index), c.length), 0), M = [], b = 1; b < d.length; b++) M.push(void 0 === (_ = d[b]) ? _ : String(_));
        var C = d.groups;
        if (h) {
    ...
    function a(t, r, n, i, o, s) {
      var a = n + t.length,
        u = i.length,
        l = fr;
      return void 0 !== o && (o = ue(o), l = pr), e.call(s, l, (function (e, s) {
        var l;
        switch (s.charAt(0)) {
          case "$":
            return "$";
  ...
  ir("split", 2, (function (t, e, r) {
    var n;
    return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, r) {
      var n, i, o = String(g(this)),
        s = void 0 === r ? mr : r >>> 0;
      if (0 === s) return [];
      if (void 0 === t) return [o];
      if (!_(n = t) || !(void 0 !== (i = n[gr]) ? i : "RegExp" == h(n))) return e.call(o, t, s);
      for (var a, u, l, c = [], p = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), f = 0, d = new RegExp(t.source, p + "g");
        (a = Ye.call(d, o)) && !((u = d.lastIndex) > f && (c.push(o.slice(f, a.index)), a.length > 1 && a.index < o.length && _r.apply(c, a.slice(1)), l = a[0].length, f = u, c.length >= s));) d.lastIndex === a.index && d.lastIndex++;
      ...
      var s = E(t),
        ...
        l = s.unicode,
        c = (s.ignoreCase ? "i" : "") + (s.multiline ? "m" : "") + (s.unicode ? "u" : "") + (yr ? "y" : "g"),
      ...
      for (var f = 0, g = 0, d = []; g < a.length;) {
        h.lastIndex = yr ? g : 0;
        var _, v = ur(h, yr ? a : a.slice(g));
        if (null === v || (_ = vr(at(h.lastIndex + (yr ? 0 : g)), a.length)) === f) g = ar(a, g, l);
        else {
  ...
  var br = function (t) {
      ...
      return Ae(e, t), e.prototype.onAdd = function () {
        ...
        return '\n<div aria-label="' + this.cluster_.getMarkerClusterer().ariaLabelFn(this.sums_.text) + '" style="' + Sr({
          position: "absolute",
    ...
    Cr = function () {
      function t(t) {
        this.markerClusterer_ = t, this.map_ = this.markerClusterer_.getMap(), this.minClusterSize_ = this.markerClusterer_.getMinimumClusterSize(), this.averageCenter_ = this.markerClusterer_.getAverageCenter(), this.markers_ = [], this.center_ = null, this.bounds_ = null, this.clusterIcon_ = new br(this, this.markerClusterer_.getStyles())
      }
  ...
  return function (t) {
    ...
    return Ae(e, t), e.prototype.onAdd = function () {
      ...
      r && r.isMarkerInClusterBounds(t) ? r.addMarker(t) : ((i = new Cr(this)).addMarker(t), this.clusters_.push(i))
    ...
    }, e.BATCH_SIZE = 2e3, e.BATCH_SIZE_IE = 500, e.IMAGE_PATH = "https://raw.githubusercontent.com/bsg-marvin/bsg-map/main/images/bsg-45", e.IMAGE_EXTENSION = "png", e.IMAGE_SIZES = [45], e
  }(xr)
}();
